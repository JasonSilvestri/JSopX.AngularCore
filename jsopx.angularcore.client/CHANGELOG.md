...
- Create Angular project with ng: `ng new jsopx.angularcore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`jsopx.angularcore.client.esproj`).
